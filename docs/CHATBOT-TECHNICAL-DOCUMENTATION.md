...
Сервис `ai-support` - это backend AI-чатбота для платформы Trading Platform.
...
6. При необходимости Gemini инициирует Function Calling к Trading Platform API.
...
| `ALLOWED_ORIGINS` | `http://localhost:4200,https://demo-frontend.example.com,https://demo.example.com` | Список allowed origins (comma-separated). |
